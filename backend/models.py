...
class User(db.Model):
    ...
    def has_permission(self, permission):
        ...
        role_hierarchy = {
            ...
            'approver': ['view_packages', 'request_packages', 'approve_packages', 'view_requests'],
            'admin': ['view_packages', 'request_packages', 'approve_packages', 'view_requests', 'manage_licenses', 'manage_users', 'view_admin']
        }
...
class Package(db.Model):
    ...
    security_scan_status = db.Column(db.String(50), default='pending')  # pending, scanning, completed, failed, skipped
...
class SecurityScan(db.Model):
    ...
    status = db.Column(db.String(50), default='pending', nullable=False)  # pending, running, completed, failed, skipped
