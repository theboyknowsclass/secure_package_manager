...
class TestPackageCacheService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch.dict(os.environ, {
            'PACKAGE_CACHE_DIR': self.test_cache_dir
        }):
    ...
    def test_get_package_cache_path_regular_package(self):
    ...
    def test_get_package_cache_path_scoped_package(self):
    ...
    def test_get_package_cache_path_special_characters(self):
        ...
        expected_path = os.path.join(self.test_cache_dir, "package-with-dashes-1.0.0")
        self.assertEqual(path, expected_path)

    def test_is_package_cached_not_cached(self):
    ...
    def test_is_package_cached_cached(self):
    ...
    def test_get_package_path_not_cached(self):
    ...
    def test_get_package_path_cached(self):
    ...
    @patch('tarfile.open')
    def test_store_package_from_tarball_success(self, mock_tarfile_open):
    ...
    @patch('tarfile.open')
    def test_store_package_from_tarball_extraction_error(self, mock_tarfile_open):
    ...
    def test_remove_package_not_exists(self):
    ...
    def test_get_cache_size_with_packages(self):
    ...
    def test_list_cached_packages_empty(self):
