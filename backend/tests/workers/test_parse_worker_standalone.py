#!/usr/bin/env python3
"""
Standalone unit tests for ParseWorker validation and extraction logic.
These tests don't require the full Flask app setup and test the core business logic in isolation.
