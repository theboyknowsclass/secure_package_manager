#!/usr/bin/env python3
"""Tests for the refactored PackageLockParsingService.

These tests focus on the business logic of the service without database dependencies.
The service can be tested with mocked operations, making tests faster and more focused.
"""
...
class TestPackageLockParsingService(unittest.TestCase):
    ...
    def test_parse_package_lock_with_new_packages(self):
        ...
        result = self.service.parse_package_lock(1, package_data, self.mock_ops)
    ...
    def test_parse_package_lock_with_existing_packages(self):
        ...
        self.mock_ops['package'].get_by_name_version.return_value = existing_package
        ...
        self.mock_ops['request_package'].create_link.assert_called_with(1, 1, "existing")

    def test_parse_package_lock_validation_error(self):
        """Test that validation errors are properly raised."""
        invalid_data = {"name": "test", "version": "1.0.0"}  # Missing lockfileVersion
