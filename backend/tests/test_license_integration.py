...
class TestLicenseIntegration(unittest.TestCase):
    ...
    def test_license_validation_in_package_processing(self):
        """Test that license validation is properly integrated in package
        processing."""
    ...
    def test_license_score_storage_in_validation(self):
        """Test that license score is properly stored during package
        validation."""
    ...
    def test_complex_license_expression_processing(self):
        """Test processing of complex license expressions in package
        validation."""
        ...
        mock_validation_result = {
            ...
            "errors": [],
            "warnings": [
                "Using best license from OR expression: (MIT OR Apache-2.0)"
            ],
        }
            ...
            with patch.object(
                ...
                with patch.object(
                    ...
                    with patch("services.package_service.db") as mock_db:
                        ...
                        # Should still store the score and allow processing
                        # (for testing)
                        self.assertEqual(self.mock_package.license_score, 0)
                        self.assertTrue(
                            result
                        )  # Currently allows 0 score for testing
    ...
    def test_license_validation_with_unknown_license(self):
        ...
        mock_validation_result = {
            ...
            "warnings": [
                'License "UNKNOWN-LICENSE" is not in the license database'
            ],
        }
