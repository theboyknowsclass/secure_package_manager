...
This package provides entity-specific database operations classes that handle
all database interactions for each entity type. Operations are organized by
entity to provide clear separation of concerns and better maintainability.
"""
...
class OperationsFactory:
    ...
    @classmethod
    def create_operations(cls, entity_type: str, session: Session) -> BaseOperations:
    ...
    @classmethod
    def create_all_operations(cls, session: Session) -> Dict[str, BaseOperations]:
