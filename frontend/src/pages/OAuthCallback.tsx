  ...
  const handleOAuthCallback = async () => {
    try {
      ...
      if (oauthService.isAuthenticated()) {
        console.log('OAuthCallback page: User already authenticated, redirecting to dashboard...');
        navigate('/');
        return;
      }
      ...
      if (result.success) {
        console.log('OAuthCallback page: OAuth callback successful, redirecting to dashboard...');
        // Redirect to dashboard after successful authentication
        navigate('/');
      } else {
        console.error('OAuthCallback page: OAuth callback failed:', result.error);
